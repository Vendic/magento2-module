    ...
    function (
        ...
        return Component.extend({
            ...
            canUseShippingAddress: ko.computed(function () {
                if(quote && quote.shippingMethod() && (quote.shippingMethod().method_code == 'postnl_pakjegemak' || quote.shippingMethod().method_code == 'dhl_parcelshop'))
                    return false;
            ...
            updateAddress: function () {
                ...
                if (this.selectedAddress() && this.selectedAddress() != newAddressOption &&
                    ...
                    this.selectedAddress().firstname.toLowerCase().indexOf("dhl") == -1
                    )
                ) {
